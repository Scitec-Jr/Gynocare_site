  ...
  return (
    <div>
      ...
      <AdminModal
        ...
        title={modal.type === 'create' ? 'Novo Agendamento' : 'Editar Agendamento'}
      ...
      >
        <div className="space-y-4">
          <FormField
            ...
            options={mockDoctors.map((d) => ({ label: d.name, value: d.id }))}
          />
          <FormField
            label="Exame"
            name="examId"
            ...
            onChange={(value) => setFormData({ ...formData, examId: Number(value) })}
            options={mockExams.map((e) => ({ label: e.name, value: e.id }))}
          />
          <FormField
            label="Data"
            name="date"
          ...
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, startTime: String(value) })}
            required
          />
          <FormField
            label="Horário Fim"
            ...
            onChange={(value) => setFormData({ ...formData, endTime: String(value) })}
            required
          />
          <FormField
            label="Telefone"
