      ...
      >
        <div className="space-y-4">
          ...
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, procedureId: Number(value) })}
            options={mockProcedures.map((p) => ({ label: p.name, value: p.id }))}
          />
          <FormField
            label="Informações"
            name="information"
            ...
            onChange={(value) => setFormData({ ...formData, information: String(value) })}
            required
          ...
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, preparation: String(value) })}
            required
